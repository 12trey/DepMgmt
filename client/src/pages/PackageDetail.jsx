...
import { Upload, Trash2, FileText, Download, RefreshCw, Pencil } from 'lucide-react';
import { getPackage, listFiles, uploadFiles, deleteFile, regeneratePackage } from '../api';
    ...
    <div className="max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500">Version {pkg.version} {pkg.vendor && `by ${pkg.vendor}`}</p>
        </div>
